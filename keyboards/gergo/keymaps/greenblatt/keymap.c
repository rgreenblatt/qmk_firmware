 ...
 *
 * ,-------------------------------------------.                         ,-------------------------------------------.
 * | Tab    | sup+1| sup+2| sup+3| sup+4| sup+5|                         | SUP+1| SUP+2| SUP+3| SUP+4| SUP+5|  BKSP  |)
 * |--------+------+------+------+------+------|------.           .------|------+------+------+------+------+--------|
 * |  - _   | PGUP | PGDN |  C-U | C-D  |   %  | EML  |           |SEC/= | left | down |  up  | right|   )  |  ' "   |
 * |--------+------+------+------+------+------|------|           |------|------+------+------+------+------+--------|
 * |  [ {   | u vol| d vol| mute | term |browse|USR_N |           |SEC/\ | left | down |  up  | right|  F9  |  ] }   |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *                    .--------.   .--------.                                 .-------.   .---------.
 *                    | Ctrl/= |   |  BASE  |                                 | LShift|   | Ctrl/\  |
 *                    '--------'   | Space  |                                 | Space |   '---------'
